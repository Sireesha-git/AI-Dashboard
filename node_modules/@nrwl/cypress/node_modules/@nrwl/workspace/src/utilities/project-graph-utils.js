...
function getSourceDirOfDependentProjects(projectName, projectGraph = project_graph_1.readCachedProjectGraph()) {
 ...
 * @param projectGraph
 */
function getProjectNameFromDirPath(projRelativeDirPath, projectGraph = project_graph_1.readCachedProjectGraph()) {
 ...
 */
function findAllProjectNodeDependencies(parentNodeName, projectGraph = project_graph_1.readCachedProjectGraph()) {
