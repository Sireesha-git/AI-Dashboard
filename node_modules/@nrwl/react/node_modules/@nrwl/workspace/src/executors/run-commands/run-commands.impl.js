...
function default_1(options, context) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (options.readyWhen && !options.parallel) {
            if (options.command || ((_a = options.commands) === null || _a === void 0 ? void 0 : _a.length) === 1) {
                process.stderr.write('Warning: "readyWhen" has no effect when a single command is run. The task will be done when the command process is completed. Ignoring.');
            }
            else {
