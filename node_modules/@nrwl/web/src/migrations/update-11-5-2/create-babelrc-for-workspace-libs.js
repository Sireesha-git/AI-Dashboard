...
function createBabelrcForWorkspaceLibs(host) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const graph = project_graph_1.reverse(yield project_graph_1.createProjectGraphAsync());
        for (const [name, p] of projects.entries()) {
            if (!utils_1.hasDependentAppUsingWebBuild(name, graph, projects)) {
                continue;
            }
            ...
            if (p.projectType === 'library' && !host.exists(babelrcPath)) {
                ...
                devkit_1.writeJson(host, babelrcPath, { presets: ['@nrwl/web/babel'] });
            }
        }
