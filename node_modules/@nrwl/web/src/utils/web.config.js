...
function getStylesPartial(wco, options) {
    ...
    if (((_b = (_a = options === null || options === void 0 ? void 0 : options.stylePreprocessorOptions) === null || _a === void 0 ? void 0 : _a.includePaths) === null || _b === void 0 ? void 0 : _b.length) > 0) {
        options.stylePreprocessorOptions.includePaths.forEach((includePath) => includePaths.push(path.resolve(wco.root, includePath)));
    }
    const partial = styles_1.getStylesConfig(wco, includePaths);
