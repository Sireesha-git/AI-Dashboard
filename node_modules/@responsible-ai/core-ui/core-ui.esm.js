...
import { RangeTypes, roundDecimal, AccessibleChart } from '@responsible-ai/mlchartlib';
import _ from 'lodash';
import { ColumnActionsMode, DetailsList, Dialog, DialogType, TextField, DialogFooter, PrimaryButton, DefaultButton, mergeStyleSets, Link, DetailsListLayoutMode, CheckboxVisibility, Stack, Text, IconButton, TooltipHost, TooltipOverflowMode, Label, getTheme, Icon, mergeStyles, Panel, ContextualMenu, FontWeights, FontSizes, DelayedRender, ComboBox, SpinButton, Position, Checkbox, ChoiceGroup, SelectionMode, Dropdown, createTheme, initializeIcons, loadTheme, Toggle, CommandBarButton, Callout, Spinner, SpinnerSize } from '@fluentui/react';
import React__default, { createElement, createRef, PureComponent, useRef, useEffect, Suspense, Component } from 'react';
...
function IsMulticlass(modelType) {
  return modelType === ModelTypes.Multiclass || modelType === ModelTypes.ImageMulticlass || modelType === ModelTypes.TextMulticlass;
}
function IsBinary(modelType) {
  return modelType === ModelTypes.Binary || modelType === ModelTypes.ImageBinary || modelType === ModelTypes.TextBinary;
}
function IsMultilabel(modelType) {
  return modelType === ModelTypes.ImageMultilabel || modelType === ModelTypes.TextMultilabel;
}
function IsObjectDetection(modelType) {
  return modelType === ModelTypes.ObjectDetection;
}
function IsClassifier(modelType) {
  return modelType === ModelTypes.Binary || modelType === ModelTypes.ImageBinary || modelType === ModelTypes.TextBinary || modelType === ModelTypes.Multiclass || modelType === ModelTypes.ImageMulticlass || modelType === ModelTypes.TextMulticlass || modelType === ModelTypes.ImageMultilabel || modelType === ModelTypes.TextMultilabel;
}
...
})(OtherChartTypes || (OtherChartTypes = {}));
...
var MulticlassClassificationEnum;
...
})(MulticlassClassificationEnum || (MulticlassClassificationEnum = {}));
...
function () {
  ...
  JointDataset.setErrorMetrics = function (row, modelType, numLabels) {
    ...
    if (IsMulticlass(modelType)) {
      row[JointDataset.ClassificationError] = row[JointDataset.TrueYLabel] !== row[JointDataset.PredictedYLabel] ? MulticlassClassificationEnum.Misclassified : MulticlassClassificationEnum.Correct;
      return;
    }
    ...
    if (IsMultilabel(modelType)) {
      ...
      row[JointDataset.ClassificationError] = misclassified ? MulticlassClassificationEnum.Misclassified : MulticlassClassificationEnum.Correct;
      return;
    }

    if (IsObjectDetection(modelType)) {
      row[JointDataset.ClassificationError] = row[JointDataset.ObjectDetectionIncorrect] !== NoLabel ? MulticlassClassificationEnum.Misclassified : MulticlassClassificationEnum.Correct;
      return;
    }
  };
  ...
  JointDataset.prototype.buildLocalFlattenMatrix = function (weightVector) {
    ...
    this.rawLocalImportance[0].forEach(function (_classArray, featureIndex) {
      ...
      _this.metaDict[key] = {
        abbridgedLabel: localization.formatString(localization.Interpret.featureImportanceOf, featureLabel),
        ...
        isCategorical: false,
        label: localization.formatString(localization.Interpret.featureImportanceOf, featureLabel)
      };
  ...
  JointDataset.prototype.initializeLabelVariables = function (args, modelTypeIsObjectDetection) {
    ...
    if (args.predictedY && !modelTypeIsObjectDetection) {
      this.updateMetaDataDict(args.predictedY, args.metadata, JointDataset.PredictedYLabel, localization.Interpret.ExplanationScatter.predictedY, localization.Interpret.ExplanationScatter.predictedY, args.targetColumn);
      ...
      }), args.metadata, JointDataset.ObjectDetectionIncorrect, localization.Interpret.ExplanationScatter.odIncorrect, localization.Interpret.ExplanationScatter.odIncorrect, args.targetColumn);
    ...
    if (args.predictedProbabilities) {
      ...
      if (args.metadata.modelType !== ModelTypes.Regression) {
        ...
        args.metadata.classNames.forEach(function (className, classIndex) {
          var label = localization.formatString(localization.Interpret.ExplanationScatter.probabilityLabel, className);
    ...
    if (args.trueY && !modelTypeIsObjectDetection) {
      this.updateMetaDataDict(args.trueY, args.metadata, JointDataset.TrueYLabel, localization.Interpret.ExplanationScatter.trueY, localization.Interpret.ExplanationScatter.trueY, args.targetColumn);
      this.hasTrueY = true;
    } else if (args.objectDetectionLabels && modelTypeIsObjectDetection) {
      this.updateMetaDataDict(args.objectDetectionLabels.map(function (label) {
        return label.correct;
      }), args.metadata, JointDataset.ObjectDetectionCorrect, localization.Interpret.ExplanationScatter.odCorrect, localization.Interpret.ExplanationScatter.odCorrect, args.targetColumn);
    ...
    if (this.hasPredictedY && this.hasTrueY) {
      ...
      if (IsBinary(args.metadata.modelType)) {
        this.metaDict[JointDataset.ClassificationError] = {
          ...
          sortedCategoricalValues: [localization.Interpret.Columns.trueNegative, localization.Interpret.Columns.falsePositive, localization.Interpret.Columns.falseNegative, localization.Interpret.Columns.truePositive],
          treatAsCategorical: true
        };
      }
      ...
      if (IsMulticlass(args.metadata.modelType) || IsMultilabel(args.metadata.modelType)) {
        this.metaDict[JointDataset.ClassificationError] = {
          ...
          isCategorical: true,
          label: localization.Interpret.Columns.classificationOutcome,
          sortedCategoricalValues: [localization.Interpret.Columns.correctlyClassified, localization.Interpret.Columns.misclassified],
          treatAsCategorical: true
        };
      }
      ...
      (_c = this.dataDict) === null || _c === void 0 ? void 0 : _c.forEach(function (row, rowIndex) {
        ...
        row[JointDataset.ClassificationError] = ((_a = _this.strDataDict) === null || _a === void 0 ? void 0 : _a[rowIndex][JointDataset.ObjectDetectionIncorrect]) !== NoLabel ? MulticlassClassificationEnum.Misclassified : MulticlassClassificationEnum.Correct;
      });
    }
  };
  ...
  JointDataset.prototype.updateMetaDataDict = function (values, metadata, labelColName, abbridgedLabel, label, targetColumn) {
    ...
    for (var i = 0; i < this.numLabels; i++) {
      ...
      var categoricalValues = metadata.modelType !== ModelTypes.Regression ? metadata.classNames : undefined;
...
function () {
  ...
  Cohort.prototype.applyFilters = function () {
    ...
    if (hasCompositeFilters) {
      filteredData = filteredData.filter(function (row) {
        return _this.filterComposite(row, _this.compositeFilters, Operations.And);
      });
    }
...
function (_super) {
  ...
  function AccessibleDetailsList(props) {
    ...
    _this.detailsListRef = /*#__PURE__*/createRef();

    _this.getMinMaxErrorMessage = function (column, columnMinWidth) {
      return localization.formatString(localization.Core.AccessibleDetailsList.minMaxErrorMessage, columnMinWidth, column.maxWidth);
    };

    _this.getMinErrorMessage = function (columnMinWidth) {
      return localization.formatString(localization.Core.AccessibleDetailsList.minErrorMessage, columnMinWidth);
    };
  ...
  AccessibleDetailsList.prototype.render = function () {
    ...
    return /*#__PURE__*/createElement("div", null, /*#__PURE__*/createElement(DetailsList, __assign({
      componentRef: this.detailsListRef,
      columns: clickableColumns
    }, rest)), /*#__PURE__*/createElement(Dialog, {
      hidden: this.state.isDialogHidden,
      onDismiss: this.closeDialog,
      dialogContentProps: {
        subText: localization.Core.AccessibleDetailsList.ResizableDialog.subText,
        title: localization.Core.AccessibleDetailsList.ResizableDialog.title,
        type: DialogType.normal
      }
    }, /*#__PURE__*/createElement(TextField, {
      ariaLabel: localization.Core.AccessibleDetailsList.ResizableDialog.subText,
      errorMessage: this.state.errorMessage,
      onChange: this.onTextFieldChange
    }), /*#__PURE__*/createElement(DialogFooter, null, /*#__PURE__*/createElement(PrimaryButton, {
    ...
    }), /*#__PURE__*/createElement(DefaultButton, {
...
function (_super) {
  ...
  function CohortList(props) {
    ...
    _this.renderItemColumn = function (item, index, column) {
      if (column !== undefined && index !== undefined) {
        ...
        switch (column.key) {
          case "nameColumn":
            if (_this.props.enableEditing && item.name !== localization.ErrorAnalysis.Cohort.defaultLabel) {
          ...
          case "detailsColumn":
            if (item.details && item.details.length === 2) {
              return /*#__PURE__*/React__default.createElement(Stack, null, /*#__PURE__*/React__default.createElement(Text, {
                variant: "xSmall"
              }, item.details[0]), /*#__PURE__*/React__default.createElement(Text, {
                variant: "xSmall"
              }, item.details[1]));
            }
  ...
  CohortList.prototype.getCohortListItems = function () {
    var allItems = this.props.errorCohorts.filter(function (errorCohort) {
      ...
      var details = [localization.formatString(localization.Interpret.CohortBanner.datapoints, errorCohort.cohort.filteredData.length), localization.formatString(localization.Interpret.CohortBanner.filters, errorCohort.cohort.filters.length)];
      return {
...
function (_super) {
  ...
  CompositeFilterList.prototype.render = function () {
    ...
    return this.props.compositeStrings.map(function (filter, index) {
      return /*#__PURE__*/React__default.createElement("div", {
        key: index
      }, filter, _this.props.removeFilter && /*#__PURE__*/React__default.createElement(IconButton, {
...
})(DatasetCohortColumns || (DatasetCohortColumns = {}));

// Copyright (c) Microsoft Corporation.
var maxLength = 18;
function getColumnItems(columnRanges, features) {
  var items = [DatasetCohortColumns.Index, DatasetCohortColumns.Dataset, DatasetCohortColumns.PredictedY, DatasetCohortColumns.TrueY, DatasetCohortColumns.ClassificationError, DatasetCohortColumns.RegressionError].reduce(function (previousValue, key) {
    var range = columnRanges && columnRanges[key];

    if (key === DatasetCohortColumns.Dataset && features && features.length > 0) {
      previousValue.push({
        key: key,
...
function (_super) {
  ...
  function FilterList() {
    ...
    _this.filterMethodLabels = (_a = {}, _a[FilterMethods.Equal] = localization.Interpret.FilterOperations.equals, _a[FilterMethods.GreaterThan] = localization.Interpret.FilterOperations.greaterThan, _a[FilterMethods.GreaterThanEqualTo] = localization.Interpret.FilterOperations.greaterThanEquals, _a[FilterMethods.LessThan] = localization.Interpret.FilterOperations.lessThan, _a[FilterMethods.LessThanEqualTo] = localization.Interpret.FilterOperations.lessThanEquals, _a[FilterMethods.Includes] = localization.Interpret.FilterOperations.includes, _a[FilterMethods.Excludes] = localization.Interpret.FilterOperations.excludes, _a[FilterMethods.InTheRangeOf] = localization.Interpret.FilterOperations.inTheRangeOf, _a);
    return _this;
  }
  ...
  FilterList.prototype.render = function () {
    ...
    return this.props.filters.filter(function (item) {
      ...
      return /*#__PURE__*/React__default.createElement("div", {
        key: index
      }, _this.setFilterLabel(filter), _this.props.editFilter && /*#__PURE__*/React__default.createElement(IconButton, {
      ...
      }), _this.props.removeFilter && /*#__PURE__*/React__default.createElement(IconButton, {
        id: "removeFilterBtn-" + index,
        iconProps: {
          iconName: "Clear"
        },
  ...
  FilterList.prototype.setFilterLabel = function (filter) {
    ...
    if ((range === null || range === void 0 ? void 0 : range.rangeType) === RangeTypes.Categorical || (range === null || range === void 0 ? void 0 : range.treatAsCategorical)) {
      isCategorical = true;
    ...
    if (isCategorical) {
      ...
      if (selectedValues_1.length > 3) {
        ...
        stringArgs = localization.formatString(localization.Interpret.FilterOperations.overflowFilterArgs, otherValues, countOtherValues.toString());
      }
    } else {
    ...
    if (filter.method === FilterMethods.InTheRangeOf) {
      // example: Age [30,40]
      label = abbridgedLabel + " " + localization.formatString(localization.Interpret.FilterOperations.inTheRangeOf, stringArgs);
    } else {
      // example: Age < 30
      label = abbridgedLabel + " " + localization.formatString(this.filterMethodLabels[filter.method], stringArgs);
    }

    return /*#__PURE__*/React__default.createElement(TooltipHost, {
...
function (_super) {
  ...
  CohortEditorFilterList.prototype.render = function () {
    ...
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Label, null, localization.Interpret.CohortEditor.addedFilters), /*#__PURE__*/React__default.createElement(FilterList, {
    ...
    }), this.props.filters.length + this.props.compositeFilters.length === 0 && /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(Text, {
      variant: "smallPlus"
...
function (_super) {
  ...
  PredictionPath.prototype.render = function () {
    ...
    return /*#__PURE__*/React__default.createElement(Stack, null, filters.reverse().map(function (filter, index) {
      return /*#__PURE__*/React__default.createElement("div", {
        key: index
        ...
        verticalAlign: "center"
      }, filter.length <= 150 ? /*#__PURE__*/React__default.createElement(Text, null, filter) : /*#__PURE__*/React__default.createElement(TooltipHost, {
        content: filter,
        id: "Filter " + index
      }, /*#__PURE__*/React__default.createElement(Text, null, filter.slice(0, 150) + " "), /*#__PURE__*/React__default.createElement(Icon, {
        iconName: "More"
...
function (_super) {
  ...
  CohortInfo.prototype.render = function () {
    ...
    }, /*#__PURE__*/React__default.createElement(DefaultButton, {
    ...
    }), /*#__PURE__*/React__default.createElement(Stack, null, /*#__PURE__*/React__default.createElement(Label, null, localization.ErrorAnalysis.CohortInfo.basicInformation), !this.props.currentCohort.isAllDataCohort && /*#__PURE__*/React__default.createElement(Text, null, this.props.currentCohort.cohort.name), /*#__PURE__*/React__default.createElement(Text, null, localization.ErrorAnalysis.Cohort.defaultLabel, " (", getCohortFilterCount(this.props.currentCohort.cohort), " ", localization.ErrorAnalysis.CohortInfo.filters, ")")), /*#__PURE__*/React__default.createElement(Stack, null, /*#__PURE__*/React__default.createElement(Label, null, localization.ErrorAnalysis.CohortInfo.baseCohortInstances), /*#__PURE__*/React__default.createElement(Text, null, localization.ErrorAnalysis.CohortInfo.total, " ", this.props.currentCohort.cohortStats.totalAll), this.props.currentCohort.cohortStats instanceof ErrorCohortStats && /*#__PURE__*/React__default.createElement(Text, null, localization.ErrorAnalysis.CohortInfo.correct, " ", this.props.currentCohort.cohortStats.totalCorrect), this.props.currentCohort.cohortStats instanceof ErrorCohortStats && /*#__PURE__*/React__default.createElement(Text, null, localization.ErrorAnalysis.CohortInfo.incorrect, " ", this.props.currentCohort.cohortStats.totalIncorrect))), /*#__PURE__*/React__default.createElement(Stack, {
      tokens: {
        childrenGap: "20px"
      }
    }, /*#__PURE__*/React__default.createElement(Stack, null, /*#__PURE__*/React__default.createElement(Label, null, localization.ErrorAnalysis.CohortInfo.selectedCohortInstances), /*#__PURE__*/React__default.createElement(Text, null, localization.ErrorAnalysis.CohortInfo.total, " ", this.props.currentCohort.cohortStats.totalCohort), this.props.currentCohort.cohortStats instanceof ErrorCohortStats && /*#__PURE__*/React__default.createElement(Text, null, localization.ErrorAnalysis.CohortInfo.correct, " ", this.props.currentCohort.cohortStats.totalCohortCorrect), this.props.currentCohort.cohortStats instanceof ErrorCohortStats && /*#__PURE__*/React__default.createElement(Text, null, localization.ErrorAnalysis.CohortInfo.incorrect, " ", this.props.currentCohort.cohortStats.totalCohortIncorrect)), /*#__PURE__*/React__default.createElement(Stack, null, /*#__PURE__*/React__default.createElement(Label, null, localization.ErrorAnalysis.CohortInfo.predictionPath), /*#__PURE__*/React__default.createElement(PredictionPath, {
...
function (_super) {
  ...
  CohortInfoSection.prototype.render = function () {
    ...
    var cohortInfoTitle = localization.ModelAssessment.CohortInformation.GlobalCohort + cohortName;

    if (currentCohort.isAllDataCohort) {
      cohortInfoTitle += localization.ModelAssessment.CohortInformation.DefaultCohort;
    }

    var datapointsCountString = localization.ModelAssessment.CohortInformation.DataPoints + " = " + currentCohort.cohortStats.totalCohort.toString();
    var filtersCountString = localization.ModelAssessment.CohortInformation.Filters + " = " + currentCohort.cohort.filters.length.toString();
    return /*#__PURE__*/React__default.createElement(Stack, {
      grow: true,
      tokens: {
        padding: "l1"
      ...
      variant: "xLarge"
    }, cohortInfoTitle), /*#__PURE__*/React__default.createElement(Stack, null, /*#__PURE__*/React__default.createElement(Text, null, datapointsCountString), /*#__PURE__*/React__default.createElement(Text, null, filtersCountString)), /*#__PURE__*/React__default.createElement(Stack, {
      horizontal: true,
      tokens: {
        childrenGap: 25
      }
...
function (_super) {
  ...
  CohortFilters.prototype.render = function () {
    ...
    return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("div", {
      ...
      className: classNames.header
    }, "Filters"), /*#__PURE__*/React__default.createElement(Stack, null, /*#__PURE__*/React__default.createElement(Stack, {
      horizontal: true,
...
function (_super) {
  ...
  CohortStats.prototype.render = function () {
    ...
    return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("div", {
      ...
      className: classNames.header
    }, localization.ErrorAnalysis.cohortInfo), /*#__PURE__*/React__default.createElement(Stack, {
      horizontal: true
    }, /*#__PURE__*/React__default.createElement(Stack, {
      tokens: alignmentStackTokens$2
    }, /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
    }, localization.ErrorAnalysis.errorCoverage), /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
    }, this.props.temporaryCohort.cohortStats.errorCoverage.toFixed(2) + "%")), /*#__PURE__*/React__default.createElement(Stack, {
      tokens: alignmentStackTokens$2
    }, /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
    }, localization.ErrorAnalysis.Metrics.metricName), /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
    }, this.props.temporaryCohort.cohortStats.metricName)), /*#__PURE__*/React__default.createElement(Stack, {
      tokens: alignmentStackTokens$2
    }, /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
    }, localization.ErrorAnalysis.Metrics.metricValue), /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
    }, this.props.temporaryCohort.cohortStats.metricName === Metrics.ErrorRate && this.props.temporaryCohort.cohortStats.metricValue.toFixed(2) + "%", this.props.temporaryCohort.cohortStats.metricName !== Metrics.ErrorRate && this.props.temporaryCohort.cohortStats.metricValue.toFixed(2))), this.props.temporaryCohort.cohortStats instanceof ErrorCohortStats && /*#__PURE__*/React__default.createElement(Stack, {
      tokens: alignmentStackTokens$2
    }, /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
    }, localization.ErrorAnalysis.correctTotal), /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
    }, this.props.temporaryCohort.cohortStats.totalCohortCorrect + " / " + this.props.temporaryCohort.cohortStats.totalCohort)), this.props.temporaryCohort.cohortStats instanceof ErrorCohortStats && /*#__PURE__*/React__default.createElement(Stack, {
      tokens: alignmentStackTokens$2
    }, /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
    }, localization.ErrorAnalysis.incorrectTotal), /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
...
function (_super) {
  ...
  EditCohort.prototype.render = function () {
    ...
    }), /*#__PURE__*/React__default.createElement(DialogFooter, null, /*#__PURE__*/React__default.createElement(Stack, {
      horizontal: true,
      disableShrink: true,
...
function (_super) {
  ...
  ConfirmationDialog.prototype.render = function () {
    ...
    return /*#__PURE__*/React__default.createElement(Dialog, {
      ...
      dialogContentProps: dialogContentProps,
      modalProps: modalProps
    }, /*#__PURE__*/React__default.createElement(DialogFooter, null, /*#__PURE__*/React__default.createElement(PrimaryButton, {
...
function translateToNewFilter(legacyFilter, featureNames) {
  ...
  var columnMap = new Map([[JointDataset.IndexLabel, DatasetCohortColumns.Index], [JointDataset.PredictedYLabel, DatasetCohortColumns.PredictedY], [JointDataset.TrueYLabel, DatasetCohortColumns.TrueY], [JointDataset.ClassificationError, DatasetCohortColumns.ClassificationError], [JointDataset.RegressionError, DatasetCohortColumns.RegressionError]]);
...
function translateToLegacyFilter(filter, featureNames) {
  ...
  var columnMap = new Map([[DatasetCohortColumns.Index, JointDataset.IndexLabel], [DatasetCohortColumns.PredictedY, JointDataset.PredictedYLabel], [DatasetCohortColumns.TrueY, JointDataset.TrueYLabel], [DatasetCohortColumns.ClassificationError, JointDataset.ClassificationError], [DatasetCohortColumns.RegressionError, JointDataset.RegressionError]]);
...
function getPropertyValues(indexes, property, dataset, modelType) {
  ...
  if (classNames && property.startsWith(DatasetCohortColumns.ProbabilityY)) {
    ...
    var i_1 = Number(property.slice(DatasetCohortColumns.ProbabilityY.length));
...
function getErrors(property, indexes, dataset, modelType) {
  if (dataset.predicted_y && dataset.true_y && !Array.isArray(dataset.true_y) && !Array.isArray(dataset.predicted_y)) {
    ...
    if (modelType === ModelTypes.Regression && property === DatasetCohortColumns.RegressionError) {
      return indexes.map(function (index) {
        return Math.abs(trueY_1[index] - predictedY_1[index]);
      });
    }

    if (property === DatasetCohortColumns.ClassificationError && modelType && IsBinary(modelType)) {
      return indexes.map(function (index) {
        return 2 * trueY_1[index] + predictedY_1[index];
      });
    }

    if (property === DatasetCohortColumns.ClassificationError && modelType && (IsMulticlass(modelType) || IsMultilabel(modelType))) {
      return indexes.map(function (index) {
        return trueY_1[index] !== predictedY_1[index] ? MulticlassClassificationEnum.Misclassified : MulticlassClassificationEnum.Correct;
      });
    }
  }
...
function () {
      ...
      for (var _b = __values(dataDict.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
        ...
        if (this.filterRow(row, this.filters)) {
          if (this.compositeFilters.length > 0) {
            if (this.filterComposite(row, this.compositeFilters, Operations.And)) {
              indexes.push(index);
            }
          } else {
            indexes.push(index);
  ...
  DatasetCohort.prototype.getDataDict = function (modelType) {
    ...
    (_e = this.dataset.true_y) === null || _e === void 0 ? void 0 : _e.forEach(function (val, index) {
      if (Array.isArray(val)) {
        val.forEach(function (subVal, subIndex) {
          dataDict[index][DatasetCohortColumns.TrueY + subIndex.toString()] = subVal;
        });
      } else {
    ...
    (_f = this.dataset.predicted_y) === null || _f === void 0 ? void 0 : _f.forEach(function (val, index) {
      if (Array.isArray(val)) {
        val.forEach(function (subVal, subIndex) {
          dataDict[index][DatasetCohortColumns.PredictedY + subIndex.toString()] = subVal;
        });
      } else {
    ...
    if (modelType === ModelTypes.Regression) {
      try {
        for (var _h = __values(dataDict.entries()), _j = _h.next(); !_j.done; _j = _h.next()) {
          ...
          dataDict[index][DatasetCohortColumns.RegressionError] = Math.abs(row[DatasetCohortColumns.TrueY] - row[DatasetCohortColumns.PredictedY]);
        }
      } catch (e_2_1) {
        e_2 = {
          error: e_2_1
      ...
      try {
        ...
        for (var _l = __values(dataDict.entries()), _m = _l.next(); !_m.done; _m = _l.next()) {
          ...
          dataDict[index][DatasetCohortColumns.ClassificationError] = 2 * row[DatasetCohortColumns.TrueY] + row[DatasetCohortColumns.PredictedY];
        }
      } catch (e_3_1) {
        e_3 = {
          error: e_3_1
      ...
      try {
        for (var _p = __values(dataDict.entries()), _q = _p.next(); !_q.done; _q = _p.next()) {
          ...
          dataDict[index][DatasetCohortColumns.ClassificationError] = row[DatasetCohortColumns.TrueY] !== row[DatasetCohortColumns.PredictedY] ? MulticlassClassificationEnum.Misclassified : MulticlassClassificationEnum.Correct;
        }
      } catch (e_4_1) {
        e_4 = {
          error: e_4_1
      ...
      try {
        for (var _s = __values(dataDict.entries()), _t = _s.next(); !_t.done; _t = _s.next()) {
          ...
          dataDict[index][DatasetCohortColumns.ClassificationError] = row[DatasetCohortColumns.ObjectDetectionIncorrect] !== NoLabel ? MulticlassClassificationEnum.Misclassified : MulticlassClassificationEnum.Correct;
        }
      } catch (e_5_1) {
        e_5 = {
          error: e_5_1
  ...
  DatasetCohort.prototype.includesValue = function (filter, val) {
    ...
    if (this.columnRanges && (((_a = this.columnRanges[filter.column]) === null || _a === void 0 ? void 0 : _a.rangeType) === RangeTypes.Categorical || this.columnRanges[filter.column].treatAsCategorical)) {
      if (filter.column === DatasetCohortColumns.PredictedY || filter.column === DatasetCohortColumns.TrueY || filter.column === DatasetCohortColumns.ClassificationError) {
  ...
  DatasetCohort.prototype.updateStatsFromData = function () {
    ...
    var totalCohortIncorrect = 0;
    var errorRate = 0;
    var trueYsCohort = getPropertyValues(this.selectedIndexes, DatasetCohortColumns.TrueY, this.dataset);
    var predYsCohort = getPropertyValues(this.selectedIndexes, DatasetCohortColumns.PredictedY, this.dataset);

    var indexes = __spreadArray([], __read(new Array(this.dataset.features.length).keys()));

    var trueYs = getPropertyValues(indexes, DatasetCohortColumns.TrueY, this.dataset);
    var predYs = getPropertyValues(indexes, DatasetCohortColumns.PredictedY, this.dataset);
...
var Announce = function Announce(props) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    role: role,
    "aria-live": ariaLive
  }, /*#__PURE__*/React__default.createElement(DelayedRender, {
    delay: delay
...
function buildIndexedNames(length, baseString) {
  return __spreadArray([], __read(new Array(length).keys())).map(function (i) {
    return localization.formatString(baseString, i.toString());
  });
}
...
function () {
  ...
  FluentUIStyles.defaultDropdownStyle = mergeStyleSets({
    container: {
      width: "100%"
    }
  }, FluentUIStyles.limitedSizeMenuDropdown);
  FluentUIStyles.smallDropdownStyle = mergeStyleSets({
    callout: {
      maxHeight: "256px",
      minWidth: "200px"
    },
  ...
  FluentUIStyles.calloutTitle = [getTheme().fonts.xLarge, {
  ...
  FluentUIStyles.calloutProps = {
    ...
    styles: {
      ...
      container: mergeStyles([FluentUIStyles.calloutContainer, {
        position: "fixed"
      }])
    }
  };
  ...
  FluentUIStyles.fluentUIColorPalette = FluentUIStyles.getFlunetUIPalette(getTheme());
  FluentUIStyles.scatterFluentUIColorPalette = FluentUIStyles.getScatterFluentUIPalette(getTheme());
  FluentUIStyles.plotlyColorHexPalette = FluentUIStyles.getFlunetUIPalette(getTheme());
...
function (_super) {
  ...
  NoneCategoricalFilterOptions.prototype.render = function () {
    ...
    var numericDelta = (columnRange === null || columnRange === void 0 ? void 0 : columnRange.rangeType) === RangeTypes.Integer || !columnRange ? 1 : (max - min) / 10;
    var styles = cohortEditorStyles();
    var minVal = columnRange ? roundDecimal(min) : undefined;
    var maxVal = columnRange ? roundDecimal(max) : undefined;
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Text, {
      block: true,
      nowrap: true,
      variant: "small"
    }, localization.formatString(localization.Interpret.Filters.min, minVal) + " " + localization.formatString(localization.Interpret.Filters.max, maxVal)), /*#__PURE__*/React__default.createElement(ComboBox, {
    ...
    }), columnRange && (openedFilter.method === FilterMethods.InTheRangeOf ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(SpinButton, {
    ...
    }), /*#__PURE__*/React__default.createElement(SpinButton, {
      ariaLabel: localization.Common.spinButton,
      labelPosition: Position.top,
    ...
    }, localization.formatString(localization.Interpret.CohortEditor.minimumGreaterThanMaximum, columnRange.min, columnRange.max))) : /*#__PURE__*/React__default.createElement(SpinButton, {
      ariaLabel: localization.Common.spinButton,
      labelPosition: Position.top,
      ...
      className: styles.invalidValueError
    }, localization.formatString(localization.Interpret.CohortEditor.invalidValueError, columnRange.min, columnRange.max)));
  };
...
function (_super) {
  ...
  function CohortEditorFilter() {
    ...
    _this.onAddFilterClick = function () {
      ...
      _this.props.setFilterMessage(localization.Interpret.CohortEditor.filterAdded);
    };
  ...
  CohortEditorFilter.prototype.render = function () {
    ...
    var isCategorical = (columnRange === null || columnRange === void 0 ? void 0 : columnRange.treatAsCategorical) || (columnRange === null || columnRange === void 0 ? void 0 : columnRange.rangeType) === RangeTypes.Categorical;
    ...
    return /*#__PURE__*/React__default.createElement(Stack, {
    ...
    }, isDataColumn && /*#__PURE__*/React__default.createElement(ComboBox, {
      ...
      calloutProps: FluentUIStyles.calloutProps
    }), columnRange && columnRange.rangeType === RangeTypes.Integer && !ifEnableLargeData(this.context.dataset) && /*#__PURE__*/React__default.createElement(Checkbox, {
      ...
      ariaLabel: isCategorical ? localization.formatString(localization.Interpret.CohortEditor.TreatAsCategoricalAriaLabelChecked, categoricalOptions === null || categoricalOptions === void 0 ? void 0 : categoricalOptions.length) : localization.formatString(localization.Interpret.CohortEditor.TreatAsCategoricalAriaLabelUnchecked, columnRange.min, columnRange.max)
    }), isCategorical ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Text, {
      variant: "small"
    }, "" + localization.formatString(localization.Interpret.Filters.uniqueValues, categoricalOptions === null || categoricalOptions === void 0 ? void 0 : categoricalOptions.length)), /*#__PURE__*/React__default.createElement(ComboBox, {
      key: this.props.openedFilter.column,
      multiSelect: true,
    ...
    }, isEditingFilter ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(PrimaryButton, {
      text: localization.Interpret.CohortEditor.save,
      onClick: function onClick() {
        return _this.props.saveState(_this.props.filterIndex);
      },
      ariaLabel: localization.Interpret.CohortEditor.saveAriaLabel
    })), /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(DefaultButton, {
      text: localization.Interpret.CohortEditor.cancel,
      onClick: function onClick() {
        return _this.props.cancelFilter();
      },
      ariaLabel: localization.Interpret.CohortEditor.cancelAriaLabel
    }))) : /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(PrimaryButton, {
...
function (_super) {
  ...
  function CohortEditorFilterSection(props) {
    ...
    _this.setComparison = function (_ev, item) {
      ...
      if (item.key === FilterMethods.InTheRangeOf) {
    ...
    _this.setNumericValue = function (delta, index, stringVal, range) {
      ...
      if (delta === 0) {
        ...
        if (!Number.isInteger(numberVal) && (range === null || range === void 0 ? void 0 : range.rangeType) === RangeTypes.Integer || numberVal > max || numberVal < min) {
          _this.setState({
  ...
  CohortEditorFilterSection.prototype.render = function () {
    ...
    return /*#__PURE__*/React__default.createElement(Stack.Item, null, !this.props.openedFilter ? /*#__PURE__*/React__default.createElement(Text, {
      variant: "medium"
    }, localization.Interpret.CohortEditor.defaultFilterState) : /*#__PURE__*/React__default.createElement(CohortEditorFilter, {
...
function (_super) {
  ...
  function CohortEditorPanelContent(props) {
    ...
    _this.clearAllFilters = function () {
      ...
      _this.setFilterMessage(localization.Interpret.CohortEditor.noFiltersApplied);
    };
  ...
  CohortEditorPanelContent.prototype.render = function () {
    ...
    return /*#__PURE__*/React__default.createElement(Stack, {
    ...
    }, /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(TextField, {
      value: this.props.cohortName,
      label: localization.Interpret.CohortEditor.cohortNameLabel,
      placeholder: localization.Interpret.CohortEditor.cohortNamePlaceholder,
      onGetErrorMessage: this.getErrorMessage,
      disabled: this.props.disableEditName,
      onChange: this.setCohortName
    })), /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(ChoiceGroup, {
    ...
    })), /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(CohortEditorFilterList, {
      ...
      filters: this.props.filters,
      jointDataset: this.props.jointDataset
    })), /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(Link, {
      className: styles.clearFilter,
      onClick: this.clearAllFilters
    }, localization.Interpret.CohortEditor.clearAllFilters), /*#__PURE__*/React__default.createElement(Announce, {
...
function (_super) {
  ...
  function CohortEditor(props) {
    ...
    _this.renderFooter = function () {
      ...
      }, !_this.props.isNewCohort && !_this.props.disableEditName && /*#__PURE__*/React__default.createElement(DefaultButton, {
        disabled: _this.props.deleteIsDisabled,
        onClick: _this.deleteCohort,
        className: styles.deleteCohort,
        ariaLabel: localization.Interpret.CohortEditor.deleteAriaLabel
      }, localization.Interpret.CohortEditor["delete"]), /*#__PURE__*/React__default.createElement(PrimaryButton, {
        onClick: function onClick() {
          return _this.saveCohort();
        },
        disabled: _this.isSaveDisabled(),
        ariaLabel: localization.Interpret.CohortEditor.saveAriaLabel
      }, localization.Interpret.CohortEditor.save), /*#__PURE__*/React__default.createElement(DefaultButton, {
        onClick: function onClick() {
          return _this.saveCohort(true);
        },
        disabled: _this.isSaveDisabled(),
        ariaLabel: localization.Interpret.CohortEditor.saveAndSwitch
      }, localization.Interpret.CohortEditor.saveAndSwitch), /*#__PURE__*/React__default.createElement(DefaultButton, {
    ...
    _this.renderCancelDialog = function () {
      ...
      return /*#__PURE__*/React__default.createElement(ConfirmationDialog, {
        ...
        subText: _this.props.isNewCohort ? localization.Interpret.CohortEditor.cancelNewCohort : localization.Interpret.CohortEditor.cancelExistingCohort,
    ...
    _this.saveCohort = function (switchNew) {
      ...
      if ((_a = _this.state.cohortName) === null || _a === void 0 ? void 0 : _a.length) {
        ...
        var newDatasetCohort = _this.props.isFromExplanation ? undefined : new DatasetCohort(_this.state.cohortName, _this.context.dataset, _this.state.filters, _this.state.compositeFilters, _this.context.modelType, _this.context.columnRanges, CohortSource.ManuallyCreated);
  ...
  CohortEditor.prototype.render = function () {
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Panel, {
...
function (_super) {
  ...
  CohortList.prototype.render = function () {
    ...
    }, /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(Stack, {
      tokens: {
        childrenGap: "s1"
      }
    }, /*#__PURE__*/React__default.createElement(PrimaryButton, {
    ...
    }))), /*#__PURE__*/React__default.createElement(Stack, null, /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(Text, {
      variant: "small"
    }, localization.Interpret.CohortBanner.dataStatistics.toUpperCase())), /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(Text, null, modelType)), /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(Text, {
      variant: "xSmall"
    }, localization.formatString(localization.Interpret.CohortBanner.datapoints, this.props.jointDataset.datasetRowCount))), /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(Text, {
      variant: "xSmall"
    }, localization.formatString(localization.Interpret.CohortBanner.features, this.props.jointDataset.datasetFeatureCount)))), /*#__PURE__*/React__default.createElement(Stack, null, /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(Text, {
      variant: "small"
    }, localization.Interpret.CohortBanner.datasetCohorts.toUpperCase())), this.props.cohorts.map(function (cohort, idx) {
      return /*#__PURE__*/React__default.createElement(Stack.Item, {
        tokens: {
          padding: "l1"
        },
        key: idx
      }, /*#__PURE__*/React__default.createElement(Stack, null, /*#__PURE__*/React__default.createElement(Text, {
        variant: "mediumPlus",
        title: cohort.name
      }, limitStringLength(cohort.name, 15)), /*#__PURE__*/React__default.createElement(Text, {
        variant: "xSmall"
      }, localization.formatString(localization.Interpret.CohortBanner.datapoints, cohort.filteredData.length)), /*#__PURE__*/React__default.createElement(Text, {
        variant: "xSmall"
      }, localization.formatString(localization.Interpret.CohortBanner.filters, cohort.filters.length))));
    })));
  };
...
function (_super) {
  ...
  CohortName.prototype.render = function () {
    return /*#__PURE__*/React__default.createElement(Stack, null, /*#__PURE__*/React__default.createElement(Text, null, this.props.cohort.name), /*#__PURE__*/React__default.createElement(Stack, {
      horizontal: true,
      tokens: {
        childrenGap: "s1"
      }
    }, this.props.index && /*#__PURE__*/React__default.createElement(Link, {
      onClick: this.onClickEditCohort
    }, localization.Interpret.CohortBanner.editCohort), /*#__PURE__*/React__default.createElement(Link, {
...
function (_super) {
  ...
  function CohortBar(props) {
    ...
    _this.cloneAndEditCohort = function (index) {
      ...
      cohorts.push(new Cohort(source.name + localization.Interpret.CohortBanner.copy, _this.props.jointDataset, __spreadArray([], __read(source.filters))));
  ...
  CohortBar.prototype.render = function () {
    ...
    if (this.state.editingCohortIndex !== undefined) {
      if (this.state.editingCohortIndex === this.props.cohorts.length) {
        cohortForEdit = {
          cohortName: localization.formatString(localization.Interpret.CohortEditor.placeholderName, this.state.editingCohortIndex),
          filterList: []
        };
      } else {
        cohortForEdit = {
...
function (_super) {
  ...
  CohortBaseAndFilters.prototype.render = function () {
    ...
    return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("div", {
      ...
      className: classNames.header
    }, localization.ErrorAnalysis.CohortBaseAndFilters.globalCohortAndFilters), /*#__PURE__*/React__default.createElement(Stack, {
      horizontal: true
    }, /*#__PURE__*/React__default.createElement(Stack, null, /*#__PURE__*/React__default.createElement(Stack, {
      horizontal: true,
      tokens: alignmentStackTokens$3
    }, /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
    }, localization.ErrorAnalysis.CohortBaseAndFilters.globalCohort)), /*#__PURE__*/React__default.createElement(Stack, {
      horizontal: true,
      tokens: alignmentStackTokens$3
    }, /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
    }, localization.ErrorAnalysis.CohortBaseAndFilters.errorExplorer)), /*#__PURE__*/React__default.createElement(Stack, {
      horizontal: true,
      tokens: alignmentStackTokens$3
    }, /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
    }, localization.ErrorAnalysis.CohortBaseAndFilters.filters))), /*#__PURE__*/React__default.createElement(Stack, null, /*#__PURE__*/React__default.createElement(Stack, {
      horizontal: true,
      tokens: alignmentStackTokens$3
    }, /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
    }, this.props.baseCohort.cohort.name)), /*#__PURE__*/React__default.createElement(Stack, {
      horizontal: true,
      tokens: alignmentStackTokens$3
    }, /*#__PURE__*/React__default.createElement("div", {
      className: classNames.tableData
    }, this.props.cohort.source)), /*#__PURE__*/React__default.createElement(Stack, {
      horizontal: true,
      tokens: alignmentStackTokens$3,
...
var allDataCopy = localization.ErrorAnalysis.SaveCohort.defaultLabelCopy;
...
})(QuestionAnsweringMetrics || (QuestionAnsweringMetrics = {}));
...
})(GenerativeTextMetrics || (GenerativeTextMetrics = {}));
...
var generateBinaryStats = function generateBinaryStats(outcomes) {
  var falseNegCount = outcomes.filter(function (x) {
    return x === ClassificationEnum.FalseNegative;
  }).length;
  var falsePosCount = outcomes.filter(function (x) {
    return x === ClassificationEnum.FalsePositive;
  }).length;
  var trueNegCount = outcomes.filter(function (x) {
    return x === ClassificationEnum.TrueNegative;
  }).length;
  var truePosCount = outcomes.filter(function (x) {
    return x === ClassificationEnum.TruePositive;
  }).length;
...
var generateMetrics = function generateMetrics(jointDataset, selectionIndexes, modelType, objectDetectionCache, objectDetectionInputs, questionAnsweringCache, generativeTextCache) {
  if (modelType === ModelTypes.ImageMultilabel || modelType === ModelTypes.TextMultilabel) {
...
function getColumnRanges(dataset, modelType) {
  ...
  ranges[DatasetCohortColumns.Index] = indexRange; // get regression error and classification error ranges

  if (dataset.predicted_y && dataset.true_y) {
    var classificationErrorRange = getClassificationErrorFeatureRange(modelType);

    if (classificationErrorRange) {
      ranges[DatasetCohortColumns.ClassificationError] = classificationErrorRange;
    }
    ...
    getRange(dataset, modelType, dataset.predicted_y, DatasetCohortColumns.PredictedY, ranges); // get feature ranges for true Y

    getRange(dataset, modelType, dataset.true_y, DatasetCohortColumns.TrueY, ranges);
  }
...
function getDatasetFeatureRange(dataset, column) {
  ...
  return isCategorical ? {
    ...
    }) ? RangeTypes.Integer : RangeTypes.Numeric,
...
function getDatasetFeatureRangeForLargeData(dataset, column) {
  ...
  return rangeType === "categorical" ? {
    ...
    rangeType: Number.isInteger(featureRange === null || featureRange === void 0 ? void 0 : featureRange.max_value) ? RangeTypes.Integer : RangeTypes.Numeric
  };
}
...
function getClassificationErrorFeatureRange(modelType) {
  if (IsBinary(modelType)) {
    return {
      rangeType: RangeTypes.Categorical,
      sortedUniqueValues: [localization.Interpret.Columns.trueNegative, localization.Interpret.Columns.falsePositive, localization.Interpret.Columns.falseNegative, localization.Interpret.Columns.truePositive]
    };
  }
  ...
  if (IsMulticlass(modelType)) {
    return {
      rangeType: RangeTypes.Categorical,
      sortedUniqueValues: [localization.Interpret.Columns.correctlyClassified, localization.Interpret.Columns.misclassified]
    };
  }
...
function getRegressionErrorFeatureRange(dataset, modelType) {
  if (modelType === ModelTypes.Regression && dataset.predicted_y && dataset.true_y) {
...
function (_super) {
  ...
  AxisConfigDialogSpinButton.prototype.render = function () {
    return /*#__PURE__*/React__default.createElement(SpinButton, {
      labelPosition: Position.top,
...
function metaDescription(metaVal) {
  ...
  var minDescription = localization.formatString(localization.Interpret.Filters.min, minVal);
  var maxDescription = localization.formatString(localization.Interpret.Filters.max, maxVal);
  var categoricalDescription = localization.formatString(localization.Interpret.Filters.uniqueValues, (_a = metaVal === null || metaVal === void 0 ? void 0 : metaVal.sortedCategoricalValues) === null || _a === void 0 ? void 0 : _a.length);
  return {
...
function (_super) {
  ...
  function AxisConfigBinOptions() {
    ...
    _this.getDitherToggle = function () {
      return /*#__PURE__*/React__default.createElement(Toggle, {
        key: "dither-toggle",
    ...
    _this.displayLogarithmicToggle = function (selectedMeta) {
      ...
      return (((_b = selectedMeta.featureRange) === null || _b === void 0 ? void 0 : _b.rangeType) === RangeTypes.Integer || ((_c = selectedMeta.featureRange) === null || _c === void 0 ? void 0 : _c.rangeType) === RangeTypes.Numeric) && allowLogarithmicScaling && allowUserInteract(_this.props.selectedColumn.property);
    };

    _this.displayCategoricalToggle = function (selectedMeta) {
      var _a;

      return ((_a = selectedMeta.featureRange) === null || _a === void 0 ? void 0 : _a.rangeType) === RangeTypes.Integer && _this.props.allowTreatAsCategorical && allowUserInteract(_this.props.selectedColumn.property);
    };
  ...
  AxisConfigBinOptions.prototype.render = function () {
    ...
    return /*#__PURE__*/React__default.createElement(Stack, null, selectedMeta.treatAsCategorical ? /*#__PURE__*/React__default.createElement(Stack.Item, {
      className: styles.hideMinMax
    }, "\xA0") : /*#__PURE__*/React__default.createElement(Stack.Item, {
      className: styles.minMax
    }, /*#__PURE__*/React__default.createElement(Text, {
      variant: "small",
      nowrap: true,
      block: true
    }, selectedColumnDesc.minDescription), /*#__PURE__*/React__default.createElement(Text, {
      variant: "small",
      nowrap: true,
      block: true
    }, selectedColumnDesc.maxDescription)), this.displayLogarithmicToggle(selectedMeta) && /*#__PURE__*/React__default.createElement(Toggle, {
    ...
    }), this.displayCategoricalToggle(selectedMeta) && /*#__PURE__*/React__default.createElement(Toggle, {
    ...
    }), (selectedMeta === null || selectedMeta === void 0 ? void 0 : selectedMeta.treatAsCategorical) ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Text, {
      variant: "small"
    }, selectedColumnDesc.categoricalDescription), this.props.canDither && this.getDitherToggle()) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null, this.props.canBin && !this.props.mustBin && /*#__PURE__*/React__default.createElement(Toggle, {
      key: "bin-toggle",
...
function getLeftItems(removeCount) {
  var leftItems = [cohortKey, JointDataset.IndexLabel, JointDataset.DataLabelRoot, JointDataset.PredictedYLabel, JointDataset.TrueYLabel, JointDataset.ClassificationError, JointDataset.RegressionError, JointDataset.ProbabilityYRoot, ColumnCategories.None];
...
function (_super) {
  ...
  function AxisConfigChoiceGroup() {
    ...
    _this.leftItems = getLeftItems(_this.props.removeCount).reduce(function (previousValue, key) {
      ...
      if (key === JointDataset.DataLabelRoot && _this.props.orderedGroupTitles.includes(ColumnCategories.Dataset) && _this.props.jointDataset.hasDataset) {
        previousValue.push({
          key: key,
      ...
      if (key === JointDataset.ProbabilityYRoot && _this.props.orderedGroupTitles.includes(ColumnCategories.Outcome) && _this.props.jointDataset.hasPredictedProbabilities) {
        previousValue.push({
          key: key,
  ...
  AxisConfigChoiceGroup.prototype.render = function () {
    return /*#__PURE__*/React__default.createElement(ChoiceGroup, {
...
function (_super) {
  ...
  function AxisConfigDialog() {
    ...
    _this.renderFooter = function () {
      return /*#__PURE__*/React__default.createElement(Stack, {
        ...
        ariaLabel: localization.Core.ShiftCohort.applyAriaLabel
      }, localization.Interpret.AxisConfigDialog.apply), /*#__PURE__*/React__default.createElement(DefaultButton, {
    ...
    _this.renderClassComboBox = function (options) {
      return _this.renderComboBox(options, localization.Interpret.AxisConfigDialog.selectClass);
    };
  ...
  AxisConfigDialog.prototype.render = function () {
    ...
    }, /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(AxisConfigChoiceGroup, __assign({}, this.props, {
    ...
    }))), this.state.selectedColumn.property === cohortKey && /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(Text, null, localization.Interpret.AxisConfigDialog.groupByCohort)), this.state.selectedColumn.property === ColumnCategories.None && /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(Text, null, localization.Interpret.AxisConfigDialog.countHelperText)), this.state.selectedColumn.property !== cohortKey && this.state.selectedColumn.property !== ColumnCategories.None && /*#__PURE__*/React__default.createElement(Stack, null, isDataColumn && this.renderComboBox(this.state.dataArray, localization.Interpret.AxisConfigDialog.selectFeature), isProbabilityColumn && this.renderClassComboBox(this.state.classArray), isMultilablePredictedYColumn && this.renderClassComboBox(this.state.multilabelPredictedYArray), isMultilableTrueYColumn && this.renderClassComboBox(this.state.multilabelTrueYArray), /*#__PURE__*/React__default.createElement(AxisConfigBinOptions, __assign({}, this.props, {
      jointDataset: this.context.jointDataset,
      defaultBinCount: AxisConfigDialog.DEFAULT_BIN_COUNT,
...
function generatePlotlyProps(jointData, chartProps, cohorts, selectedCohortIndex) {
  ...
  if (chartProps.yAxis.property === cohortKey) {
    ...
    cohorts.forEach(function (cohort, cohortIndex) {
      var cohortXs = cohort.unwrap(chartProps.xAxis.property, chartProps.chartType === ChartTypes.Histogram);
...
function generateDefaultChartAxes$1(context) {
  ...
  var chartProps = {
    chartType: context.jointDataset.metaDict[bestModelMetricKey].isCategorical ? ChartTypes.Histogram : ChartTypes.Box,
    xAxis: {
      options: {
        bin: false
      },
...
function (_super) {
  ...
  function OverallMetricChart(props) {
    ...
    _this.onXSet = function (value) {
      ...
      newProps.chartType = ((_a = _this.context.jointDataset.metaDict[value.property]) === null || _a === void 0 ? void 0 : _a.treatAsCategorical) ? ChartTypes.Histogram : ChartTypes.Box;
  ...
  OverallMetricChart.prototype.render = function () {
    ...
    if (!this.context.jointDataset.hasPredictedY) {
      return /*#__PURE__*/React__default.createElement(MissingParametersPlaceholder, null, localization.Interpret.ModelPerformance.missingParameters);
    }
    ...
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, cohortOptions && /*#__PURE__*/React__default.createElement("div", {
    ...
    }, localization.Interpret.ModelPerformance.cohortPickerLabel), /*#__PURE__*/React__default.createElement(Dropdown, {
      styles: {
        dropdown: {
          width: 150
        }
      ...
      ariaLabel: localization.Interpret.DatasetExplorer.datasetCohortDropdown
    })), /*#__PURE__*/React__default.createElement("div", {
      ...
      canBin: this.state.chartProps.chartType === ChartTypes.Histogram || this.state.chartProps.chartType === ChartTypes.Box,
      mustBin: this.state.chartProps.chartType === ChartTypes.Histogram || this.state.chartProps.chartType === ChartTypes.Box,
    ...
    }, /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(DefaultButton, {
    ...
    }, /*#__PURE__*/React__default.createElement(AccessibleChart, {
      plotlyProps: plotlyProps,
      theme: getTheme()
    })), this.context.modelMetadata.modelType !== ModelTypes.Multiclass && /*#__PURE__*/React__default.createElement("div", {
      className: classNames.rightPanel
    }, !this.context.jointDataset.hasTrueY && /*#__PURE__*/React__default.createElement(MissingParametersPlaceholder, null, localization.Interpret.ModelPerformance.missingTrueY), this.context.jointDataset.hasTrueY && metricsList.map(function (stats, index) {
      return /*#__PURE__*/React__default.createElement("div", {
        ...
        return /*#__PURE__*/React__default.createElement(Text, {
          block: true,
          key: statIndex
        }, localization.formatString(labeledStat.label, labeledStat.stat.toLocaleString(undefined, {
...
function (_super) {
  ...
  AxisConfig.prototype.render = function () {
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(DefaultButton, {
...
function (_super) {
  ...
  ErrorDialog.prototype.render = function () {
    ...
    return /*#__PURE__*/React__default.createElement(Dialog, {
      ...
      dialogContentProps: dialogContentProps,
      modalProps: modalProps
    }, /*#__PURE__*/React__default.createElement(DialogFooter, null, /*#__PURE__*/React__default.createElement(DefaultButton, {
      onClick: this.props.onClose,
      text: this.props.cancelButtonText
    })));
  };
...
function (_super) {
  ...
  ExpandableText.prototype.render = function () {
    ...
    return /*#__PURE__*/React__default.createElement(Text, __assign({}, this.props), this.props.iconName && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Icon, {
      iconName: this.props.iconName
    }), "\xA0"), this.props.children, ((_a = this.state) === null || _a === void 0 ? void 0 : _a.expanded) && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, "\xA0", this.props.expandedText), this.props.expandedText && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, "\xA0", /*#__PURE__*/React__default.createElement(Link, {
      onClick: this.toggle
    }, ((_b = this.state) === null || _b === void 0 ? void 0 : _b.expanded) ? localization.Core.ExpandableText.SeeLess : localization.Core.ExpandableText.SeeMore)));
  };
...
function (_super) {
  ...
  LabelWithCallout.prototype.render = function () {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
    ...
    }, this.props.type === "button" ? /*#__PURE__*/React__default.createElement(CommandBarButton, {
      iconProps: {
        iconName: "Info"
      },
      id: id,
    ...
    }) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Text, {
      id: id,
      variant: "medium",
      className: classNames.calloutText
    }, this.props.label), /*#__PURE__*/React__default.createElement(IconButton, {
      id: iconButtonId,
      iconProps: {
        iconName: "Info"
      },
      ...
      onClick: this.toggleCallout
    })), this.state.showCallout && /*#__PURE__*/React__default.createElement(Callout, {
...
function (_super) {
  ...
  HeaderWithInfo.prototype.render = function () {
    ...
    return /*#__PURE__*/React__default.createElement(Stack, {
      horizontal: true,
      id: this.props.id
    }, /*#__PURE__*/React__default.createElement(Stack.Item, null, /*#__PURE__*/React__default.createElement(Text, {
      variant: "large",
      className: styles.boldText
    }, this.props.title)), /*#__PURE__*/React__default.createElement(Stack.Item, {
      ...
      block: true
    }, this.props.calloutDescription), /*#__PURE__*/React__default.createElement(Link, {
...
function (_super) {
  ...
  InteractiveLegendEditAndDeleteButton.prototype.render = function () {
    return /*#__PURE__*/React__default.createElement("div", null, this.props.onEdit !== undefined && /*#__PURE__*/React__default.createElement(IconButton, {
      ...
      onClick: this.onEdit
    }), this.props.onDelete !== undefined && /*#__PURE__*/React__default.createElement(IconButton, {
...
function HighchartReact(props) {
  var chartRef = useRef();
  var containerRef = /*#__PURE__*/createRef();
  ...
  var createChart = function createChart() {
    ...
    try {
      chart$1 = containerRef.current && chart(containerRef.current, __assign({}, props.chartOptions));
    } catch (error) {
      if (props.onError) {
        props.onError(error);
      }
...
function (_super) {
  ...
  HighchartWrapper.prototype.render = function () {
    ...
    var _e = chartOptions.custom,
        custom = _e === void 0 ? {} : _e;
    var fallback = this.props.fallback || /*#__PURE__*/createElement("div", null);
    ...
    var mergedOptions = _.merge({}, getDefaultHighchartOptions(getTheme()), chartOptions, plotClassName && {
      chart: {
    ...
    return /*#__PURE__*/createElement(Suspense, {
      fallback: fallback
    }, /*#__PURE__*/createElement(HighchartReact, {
      className: className,
      id: this.props.id,
...
function (_super) {
  ...
  BasicHighChart.prototype.render = function () {
    ...
    var defaultOptions = getDefaultHighchartOptions(getTheme());
    var _c = this.props,
...
var boxChartTooltipDefaultSetting = {
  pointFormat: '<span style="color:{point.color}">●</span> <b>{series.name}</b><br/>' + (localization.ModelAssessment.ModelOverview.BoxPlot.upperWhisker + ": {point.high}<br/>") + (localization.ModelAssessment.ModelOverview.BoxPlot.upperQuartile + ": {point.q3}<br/>") + (localization.ModelAssessment.ModelOverview.BoxPlot.median + ": {point.median}<br/>") + (localization.ModelAssessment.ModelOverview.BoxPlot.lowerQuartile + ": {point.q1}<br/>") + (localization.ModelAssessment.ModelOverview.BoxPlot.lowerWhisker + " {point.low}<br/>")
};
...
function getDependenceData(chartProps, jointData, cohort) {
  ...
  if (chartProps.yAxis) {
    var yLabel_1 = localization.Interpret.Charts.featureImportance;
    ...
    if (identityFeatureName_1) {
      ...
      if (jointDatasetFeatureName_1) {
        ...
        rawIdentityFeatureData.forEach(function (val, index) {
          ...
          customData[index].template += localization.Common.identityFeature + " (" + identityFeatureName_1 + "): " + customData[index].ID + "<br>";
        });
      }
    }
  }
  ...
  indices.forEach(function (absoluteIndex, i) {
    ...
    customData[i].template += localization.Interpret.Charts.rowIndex + ": " + absoluteIndex + "<br>";
...
function (_super) {
  ...
  FeatureImportanceDependence.prototype.render = function () {
    ...
    var yAxisLabel = this.props.metadata.modelType === ModelTypes.Regression ? this.props.jointDataset.metaDict[this.props.chartProps.xAxis.property].label : this.props.jointDataset.metaDict[this.props.chartProps.xAxis.property].label + " : " + this.props.selectedWeightLabel;
    return /*#__PURE__*/React__default.createElement(Stack, {
      horizontal: false,
    ...
    }, localization.Interpret.DependencePlot.featureImportanceOf), /*#__PURE__*/React__default.createElement(Text, {
      variant: "medium"
    }, yAxisLabel))), /*#__PURE__*/React__default.createElement(Stack.Item, {
      className: classNames.chart
    }, /*#__PURE__*/React__default.createElement(BasicHighChart, {
      configOverride: getDependencyChartOptions(getDependenceData(this.props.chartProps, this.props.jointDataset, this.props.cohort), this.props.jointDataset.metaDict[this.props.chartProps.xAxis.property].sortedCategoricalValues, FluentUIStyles.fluentUIColorPalette[this.props.cohortIndex], this.props.logarithmicScaling, getTheme())
    })))), /*#__PURE__*/React__default.createElement(Stack.Item, {
      className: classNames.horizontalAxisWithPadding
    }, /*#__PURE__*/React__default.createElement("div", {
      className: classNames.paddingDiv
...
// Copyright (c) Microsoft Corporation.
var loadingSpinnerStyles = mergeStyleSets({
  explanationSpinner: {
    margin: "auto",
    padding: "40px"
  }
...
function (_super) {
  ...
  LoadingSpinner.prototype.render = function () {
    ...
    return /*#__PURE__*/React__default.createElement(Spinner, {
      ...
      label: (_a = this.props.label) !== null && _a !== void 0 ? _a : localization.Interpret.BarChart.calculatingExplanation
    });
  };
...
function (_super) {
  ...
  FeatureImportanceBar.prototype.render = function () {
    ...
    }, !this.props.loading && /*#__PURE__*/React__default.createElement(Stack.Item, {
  ...
  FeatureImportanceBar.prototype.getHighchartOption = function () {
    return this.props.chartType === ChartTypes.Bar ? getFeatureImportanceBarOptions(this.props.sortArray, this.props.unsortedX, this.props.unsortedSeries, this.props.topK, getTheme(), this.props.originX, this.props.onFeatureSelection) : getFeatureImportanceBoxOptions(this.props.sortArray, this.props.unsortedX, this.props.unsortedSeries, this.props.topK, getTheme(), this.props.onFeatureSelection);
  };
      ...
      if (((_c = jointDataset.datasetMetaData) === null || _c === void 0 ? void 0 : _c.featureMetaData) !== undefined) {
        ...
        if (identityFeatureName !== undefined) {
          ...
          if (jointDatasetFeatureName !== undefined) {
            ...
            hovertemplate += localization.Common.identityFeature + " (" + metaIdentityFeature_1.label + "): " + customdata[index].ID + "<br>";
          }
        }
      }
...
function getBubbleChartOptions(data, xAxisLabel, yAxisLabel, chartProps, jointData, selectedPointsIndexes, customPoints, isScatterPlotDataLoading, showColorAxis, useDifferentColorForScatterPoints, onBubbleClick, selectPointFromChartLargeData, onIndexSeriesUpdated) {
  ...
  return {
    ...
    tooltip: {
      ...
      footerFormat: "</table>",
      headerFormat: "<table>",
      pointFormat: xAxisLabel + ": {point.x}<br>" + (yAxisLabel + ": {point.y}<br>") + (localization.Counterfactuals.Size + ": {point.z}<br>"),
      useHTML: true
    },
    xAxis: {
      gridLineWidth: 1,
...
export { AccessibleDetailsList, Announce, AxisConfig, AxisConfigDialog, AxisConfigDialogSpinButton, AxisTypes, BaseCohortStats, BasicHighChart, BinaryClassificationMetrics, ChartTypes, ClassificationEnum, Cohort, CohortBar, CohortBasedComponent, CohortEditor, CohortEditorFilterList, CohortInfo, CohortInfoPanel, CohortInfoSection, CohortList, CohortListPanel, CohortNameColumn, CohortSource, ColumnCategories, ComparisonTypes, ConfirmationDialog, DatasetCohort, DatasetCohortColumns, DatasetTaskType, EditCohort, ErrorCohort, ErrorCohortStats, ErrorDialog, ExpandableText, FeatureImportanceBar, FeatureImportanceDependence, FilterMethods, FluentUIStyles, GenerativeTextMetrics, HeaderWithInfo, HeatmapHighChart, HighchartsNull, InteractiveLegend, IsBinary, IsClassifier, IsMulticlass, IsMultilabel, IsObjectDetection, JointDataset, LabelWithCallout, LoadingSpinner, MetricCohortStats, Metrics, MissingParametersPlaceholder, modelAssessmentContext as ModelAssessmentContext, ModelExplanationUtils, ModelTypes, MulticlassClassificationEnum, MulticlassClassificationMetrics, MultilabelMetrics, NoData, NoLabel, ObjectDetectionMetrics, Operations, OtherChartTypes, OverallMetricChart, PredictionPath, PredictionTypes, QuestionAnsweringMetrics, RegressionMetrics, SVGToolTip, SaveCohort, ShiftCohort, SortingState, SpinButtonStyles, TelemetryEventName, TelemetryLevels, TotalCohortSamples, WeightVectors, areRowPredTrueLabelsEqual, boxChartTooltipDefaultSetting, buildGlobalProperties, buildIndexedNames, buildScatterTemplate, calculateBoxPlotData, calculateBoxPlotDataFromErrorCohort, calculateBoxPlotDataFromSDK, calculateBubblePlotDataFromErrorCohort, calculateBubblePlotDataFromSDK, calculateConfusionMatrixData, calculateLinePlotData, calculateSplinePlotDataFromErrorCohort, cohortKey, compareChartProps, constructCols, constructRows, dataBalanceExperienceFlight, defaultModelAssessmentContext, defaultTheme, descriptionMaxWidth, featureColumnsExist, featureFlightSeparator, featureFlights, flexLgDown, flexMdDown, flexSmDown, flexXlDown, flipComparisonType, fullLgDown, fullXlDown, generateDefaultChartAxes, generateDefaultYAxis, generateGenerativeTextStats, generateMetrics, generateMicroMacroMetrics, generateMulticlassStats, generateMultilabelStats, generateObjectDetectionStats, generateQuestionAnsweringStats, generateRoute, getBasicFilterString, getBoxData, getBubbleChartOptions, getChartColors, getChartColorsMap, getClassLength, getClassLengthFromProbabilityY, getClassLengthFromTextImportances, getCohortFilterCount, getColumnRanges, getCompositeFilterString, getDependencyChartOptions, getFeatureNamesAfterDrop, getFeatureOptions, getFilterBoundsArgs, getFilters, getInitialClusterState, getModelType, getModelTypeFromExplanation, getModelTypeFromTextExplanation, getPercentile, getPrimaryBackgroundChartColor, getPrimaryChartColor, getRandomId, getScatterOption, getScatterPlot, hasAxisTypeChanged, hasAxisTypeUpdated, hideLgDown, hideXlDown, hideXxlUp, ifEnableLargeData, initializeOfficeFabric, instanceOfHighChart, isFlightActive, isNumber, isThreeDimArray, isTimeOrTimeSeriesIDColumn, isTwoDimArray, limitStringLength, mayBecomeNumber, nameof, noPaddingMdDown, orderByTime, parseFeatureFlights, rowErrorSize, rowsFromCustomPoints, setOutlierDataIfChanged, stringFormat, tableStyles, toScientific, translateToLegacyFilterColumn, translateToLegacyFilters, translateToNewFilter, translateToNewFilters };
