...
// Copyright (c) Microsoft Corporation.
var accessibleChartStyles = mergeStyleSets({
  chart: {
    height: "100%",
    width: "100%"
  },
...
var AccessorMappingFunctionNames;

(function (AccessorMappingFunctionNames) {
  AccessorMappingFunctionNames["StringifyText"] = "string";
})(AccessorMappingFunctionNames || (AccessorMappingFunctionNames = {}));
...
var accessorMappingFunctions = (_a = {}, _a[AccessorMappingFunctionNames.StringifyText] = stringify, _a);
...
export { AccessibleChart, AccessorMappingFunctionNames, ChartBuilder, DefaultSelectionFunctions, ModelMetadata, PlotlyMode, PlotlyThemes, RangeTypes, SelectionContext, accessorMappingFunctions, chartColors, roundDecimal };
