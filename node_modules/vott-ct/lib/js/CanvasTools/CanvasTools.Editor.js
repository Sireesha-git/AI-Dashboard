...
const MaskManager_1 = require("./Region/Mask/MaskManager");
...
class Editor {
    constructor(container, areaSelector, regionsManager, filterPipeline, zoomProperties, enableMask) {
        ...
        this.editorSVG.style["z-index"] = constants_1.SvgHostZIndex;
        this.contentCanvas.style["z-index"] = constants_1.ImageCanvasZIndex;
    }
    /**
